...
import com.example.sythnews.databinding.ActivityNoteAddUpdateBinding
import com.example.sythnews.R
import com.example.sythnews.note.database.Note
import com.example.sythnews.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
        ...
        if (isEdit) {
            ...
            if (note != null) {
                note?.let { note ->
                    ...
                    binding?.edtLink?.setText(note.link)
                }
            }
        } else {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        if (isEdit) {
            //Membuat menu berubah(memunculkan trashbin) pada saat ingin merubah form
